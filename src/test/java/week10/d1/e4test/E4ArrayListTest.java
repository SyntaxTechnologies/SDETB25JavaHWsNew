package week10.d1.e4test;



import org.example.week10.d1.e4.E4ArrayList;
...
public class E4ArrayListTest {
    ...
    public void testChatMessagesAfterRemovals() {
        ...
        E4ArrayList.main(new String[]{});

        // Build the expected output string
        String expectedOutput = "Enter 5 chat messages:"+ System.lineSeparator() +"Remaining messages:" + System.lineSeparator() +
                "How are you? Thanks! ";
